...
get_header(); ?>
    ...
    <li data-transition="fade" data-slotamount="4" data-masterspeed="1500" >
        <!-- MAIN IMAGE -->
        <img src="<?php echo get_template_directory_uri() ?>/sliderimages/slide_5.jpg" alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
        <!-- LAYERS -->
    ...
    <li data-transition="zoomout" data-slotamount="4" data-masterspeed="1000" >
        <!-- MAIN IMAGE -->
        <img src="<?php echo get_template_directory_uri() ?>/sliderimages/slide_6.jpg" alt="slidebg2"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
        <!-- LAYERS -->
    ...
    <li data-transition="cube-horizontal" data-slotamount="4" data-masterspeed="1000" >
        <!-- MAIN IMAGE -->
        <img src="<?php echo get_template_directory_uri() ?>/sliderimages/slide_1.jpg" alt="slidebg3"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
        <!-- LAYERS -->
    ...
    <li data-transition="zoomin" data-slotamount="4" data-masterspeed="1000" >
        <!-- MAIN IMAGE -->
        <img src="<?php echo get_template_directory_uri() ?>/sliderimages/slide_7.jpg" alt="slidebg4"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
        <!-- LAYERS -->
